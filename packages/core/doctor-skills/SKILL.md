...
1. 调用 [`verify.sh`](/Users/zhangyufan/Workspace/skills-central/shared/scripts/verify.sh)  
...
```bash
bash ~/Workspace/skills-central/packages/core/doctor-skills/doctor-skills.sh --json
```
...
- [`doctor-skills.sh`](/Users/zhangyufan/Workspace/skills-central/packages/core/doctor-skills/doctor-skills.sh)
