...
更新已经安装到源码层 `~/Workspace/skills-central`，并已导出到运行时层 `~/.agents/skills` 的 skills。
...
回调 [`install-skill`](/Users/zhangyufan/Workspace/skills-central/packages/core/install-skill/SKILL.md) 的安装链路完成更新。
...
- [`update-skill.sh`](/Users/zhangyufan/Workspace/skills-central/packages/core/update-skill/update-skill.sh)
